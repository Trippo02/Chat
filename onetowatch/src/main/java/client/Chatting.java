...
class Chatting extends JFrame {
    Vector chatperide = new Vector();
    Vector chatperidetroppo = new Vector(2);
    //Nome dell'utente
    String nome;
    boolean log = false;
    /**
    ...
    private void initComponents() {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(Messaggi, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(ButtonInvio, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(6, 6, 6)
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(NomeUtente, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(ButtonInvio, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
    ...
    private void NomeUtenteFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_NomeUtenteFocusGained
        ...
        NomeUtente.setForeground(Color.black);
    ...
    private void OkbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OkbuttonActionPerformed
        ...
        NomeUtente.setText(n);
        Messaggi.setEnabled(true);
        nome = NomeUtente.getText();
        if(!chatperide.contains(nome)){
        chatperide.add(nome);
        ChatClient client = new ChatClient("127.0.0.1", 8818, nome);
        if(!client.Connetti()){
            System.err.println("Connessione fallita");
            chatperide.remove(nome);
        }else{
    ...
    private void MessaggiFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_MessaggiFocusGained
        if(Messaggi.getText().equals("Scrivi il tuo messaggio")){
            Messaggi.setText("");
        }
    ...
    private void MessaggiFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_MessaggiFocusLost
        if(Messaggi.getText().equals("")){
            Messaggi.setText("Scrivi il tuo messaggio");
        }
        Messaggi.setForeground(new Color(102, 102, 255));               
